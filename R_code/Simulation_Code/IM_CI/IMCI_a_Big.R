...
dir.create ("C:/Users/th2953/Dropbox/Columbia/WGAN_IQ/Data/Simulations/IMCI_Big/")

setwd ("C:/Users/th2953/Dropbox/Columbia/WGAN_IQ/Data/Simulations/IMCI_Big/")


for(k in 1:10){
  
  namek = paste('IMCIaBig_', k, '.csv', sep = '') 
  namek_true = paste('IMCIaBig_', k, '_True.csv', sep = '') 
  means = rnorm(p , 0, 1)
