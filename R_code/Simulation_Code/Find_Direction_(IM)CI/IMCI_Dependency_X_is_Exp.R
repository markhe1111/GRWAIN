...
setwd ("C:/Users/markh/Dropbox/Columbia/GRWAIN/Simulations/IMCI/Clustered")
...
for(k in 1:10){
  ...
  namek = paste('AllPos1_', k, '.csv', sep = '') 
  namek_true = paste('AllPos1_', k, '_True.csv', sep = '') 
  ...
  Xy_na = list()
   ...
   for( j in 1:20){
    ...
    p_obs_y=    1 - ( y  +1)/ max( ( y +1))           # probablity of being observed
